            ...
            <div class="card">
                ...
                <div class="card-body">
                    <table class="table table-bordered">
                        <thead>
                            <tr>
                                <td class="text-center align-middle" rowspan="3">Khối lượng <br><small>(kg)</small></td>
                        ...
                        <tbody>
                            <tr v-for="(item, index) in current_const.items" :key="index" v-if="current_const.items.length > 0">
                                ...
                                <td class="text-center">
                                    <input type="text" v-model="item.gia.vungmien.in.layhang" class="form-control">
                                </td>
                                <td class="text-center">
                                    <input type="text" v-model="item.gia.vungmien.out.mangra" class="form-control">
                                </td>
                                <td class="text-center">
                                    <input type="text" v-model="item.gia.vungmien.out.layhang" class="form-control">
                                </td>
                                <!-- Nội Tỉnh / Liên Tỉnh -->
                                <td class="text-center">
