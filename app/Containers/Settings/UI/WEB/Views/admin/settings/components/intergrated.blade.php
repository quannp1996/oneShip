                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ old('intergrated.mail_driver', @$data['intergrated']['mail_driver']) }}"
                                    required>
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ old('intergrated.mail_host', @$data['intergrated']['mail_host']) }}"
                                    required>
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ old('intergrated.mail_port', @$data['intergrated']['mail_port']) }}"
                                    required>
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ old('intergrated.mail_username', @$data['intergrated']['mail_username']) }}"
                                    required>
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <input type="password"
                                    ...
                                    value="{{ old('intergrated.mail_password', @$data['intergrated']['mail_password']) }}"
                                    required>
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ old('intergrated.mail_encryption', @$data['intergrated']['mail_encryption']) }}"
                                    required>
                            </div>
                        </div>
                        <div class="col-sm-3">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ old('intergrated.mail_from_name', @$data['intergrated']['mail_from_name']) }}"
                                    required>
                            </div>
                        </div>
                    </div>
