 ...
 * @ Modified time: 2021-10-26 11:07:40
...
class OrderCancelPushNotiEventHandler extends BaseFrontEventHandler
{
    ...
    public function handle(OrderCancelEvent $event)
    {
        ...
        if ( !empty($currentOrder->customer_id) ) {
            $message = sprintf('Đơn hàng: %s, vừa mới hủy!', $currentOrder->code);
