    ...
    <div class="admin-main-layout" id="addressVUE">
        <div class="admin-main-container xl">
            <div class="d-flex justify-content-between mt-20">
                ...
                <!-- Modal Nguoi Gui-->
                <div class="modal fade" id="modalNguoiGui" tabindex="-1" role="dialog" aria-labelledby=""
                    aria-hidden="true">
                    <div class="modal-dialog modal-md " role="document">
                        <div class="modal-content">
                            <div class="modal-custom-header">
                                <div class="title">
                                    Lưu địa chỉ người gửi mới!
                                </div>
                                    ...
                                    <div class="row">
                                                ...
                                                <div class="admin-form-item-control-input">
                                                    <div class="admin-form-item-control-input-content">
                                                        <input placeholder="Vui lòng nhập họ tên" id="name"
                                                            class="admin-form-input unvalid" type="text"
                                                            value="duong" />
                                                        <small class="error">
                                                            Bắt buộc
                                                        </small>
                                                ...
                                                <div class="admin-form-item-control-input">
                                                    <div class="admin-form-item-control-input-content">
                                                        <input placeholder="Vui lòng nhập số điện thoại" id="mobile"
                                                            class="admin-form-input" type="text" value="039487773" />
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-12 mb-2">
                                            <div
                                                ...
                                                <button class="btn-themes nocolor-btn mr-2" data-dismiss="modal"
                                                    type="button">
                                                    Hủy
                                                </button>
                ...
                <!-- Modal Nguoi Nhan-->
                <div class="modal fade" id="modalNguoiNhan" tabindex="-1" role="dialog" aria-labelledby=""
                    aria-hidden="true">
                    <div class="modal-dialog modal-md " role="document">
                        <div class="modal-content">
                            <div class="modal-custom-header">
                ...
                <div class="admin-card-body">
                    ...
                    <div class="tab-content" id="myTabContent">
                                    ...
                                    <div class="admin-table-body">
                                        <div>
                                            <div class="d-flex custom-row">
                                                <div class="variable-cell" style="width: 200px;"><span
                                                        class="admin-tag admin-tag-success">Địa chỉ mặc
                                                        định</span><span>duong</span></div>
                                                <div class="variable-cell" style="width: 172px;"><span>0346407405</span>
                                                </div>
                                                <div class="variable-cell" style="width: 458px;"><span>VN - 62 phan văn
                                                        trị,đống đa,Thu Do Ha Noi </span></div>
                                                <div class="variable-cell" style="width: 220px;">
                                                    <span>duongtac22@gmail.com</span></div>
                                                <div class="variable-cell" style="width: 100px;">
                                                    <div class="btnWrapper-table">
                                                        <a class="mr-12" href="javascript:;" data-toggle="modal"
                                                            data-target="#edit-item-1">
                                                        ...
                                                        <a class="" href="javascript:;" data-toggle="modal"
                                                            data-target="#delete-item-1">
                                                            <svg class="color-f86140" focusable="false"
                                                    ...
                                                    <!-- Modal Delete-->
                                                    <div class="modal fade" id="delete-item-1" tabindex="-1"
                                                                ...
                                                                <div class="modal-custom-form mh-auto p-4">
                                                                    <div class="form-group mb-0">
                                                                        <div class="row">
                                                                            <div class="col-12 mb-3">
                                                                                <div
                                                                                    class="admin-modal-confirm-body d-flex align-items-center">
                                                                                    <span role="img"
                                                                            ...
                                                                            <div class="col-12">
                                                                                <div
                                                                                    class="modal-custom-actions d-flex align-items-center justify-content-end">
                                                                                    <button
                                                                                        class="btn-themes nocolor-btn mr-2"
                                                                                        data-dismiss="modal"
                                                                                        type="button">
                                                                                        Hủy
                                                                                    </button>
                                                                                    <button class="btn-themes color-btn"
                                                                                        type="submit">
                                                                                        Xác nhận
                                                                                    </button>
                                                                                </div>
                                                    ...
                                                    <!-- Modal Edit-->
                                                    <div class="modal fade" id="edit-item-1" tabindex="-1"
                                                        role="dialog" aria-labelledby="" aria-hidden="true">
                                                        <div class="modal-dialog modal-md " role="document">
                                                            <div class="modal-content">
                                                                <div class="modal-custom-header">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <div class="row">
                                                                            <div class="col-6 mb-3">
                                                                                <div class="admin-form-item-label">
                                                                                    <label for="name"
                                                                                        class="admin-form-item-required"
                                                                                        title="Họ tên">
                                                                                        Họ tên
                                                                                    </label>
                                                                                </div>
                                                                                <div class="admin-form-item-control">
                                                                                    <div
                                                                                        class="admin-form-item-control-input">
                                                                                        <div
                                                                                            class="admin-form-item-control-input-content">
                                                                                            <input
                                                                                ...
                                                                                <div class="admin-form-item-control">
                                                                                    <div
                                                                                        ...
                                                                                        <div
                                                                                            class="admin-form-item-control-input-content">
                                                                                            <input
                                                                                                placeholder="Vui lòng nhập thôn/ Xóm"
                                                                                                id="warp"
                                                                                                class="admin-form-input"
                                                                                                type="text"
                                                                                                value="" />
                                                                                ...
                                                                                <div class="admin-form-item-control">
                                                                                    <div
                                                                                        ...
                                                                                        <div
                                                                                            class="admin-form-item-control-input-content">
                                                                                            <input
                                                                                                placeholder="Vui lòng nhập mã zip code"
                                                                                                id="zipcode"
                                                                                                class="admin-form-input"
                                                                                                type="text"
                                                                                                value="" />
                                                                            ...
                                                                            <div class="col-12 mb-3">
                                                                                <div class="custom-radio-input">
                                                                                    <input type="radio" id="type1"
                                                                                        value="1" name="form_check"
                                                                                        checked="">
                                                                                    <label for="type1">
                                                                                        <span
                                                                                            class="icon-radio mr-2"></span>
                                                                                        Đặt làm địa chỉ giao hàng mặc định
                                                                                    </label>
                                                                                </div>
                        ...
                        <div class="tab-pane fade" id="receiver" role="tabpanel" aria-labelledby="receiver-tab">
                            <!-- empty -->
                            <div class="text-20 mt-30 mb-50 text-center font-weight-bold text-dark">
                                <img class="img-fluid" src="images/empty-img.png" alt="" />
                                <p>Bạn có thể cài đặt địa chỉ thường dùng của người nhận và người gửi tại đây để nâng cao
                                    hiệu quả quản lý vận chuyển</p>
                                <a class="btn-themes color-btn" href="javascript:;" data-toggle="modal"
                                    data-target="#modalNguoiNhan">
                                    <div class="d-flex align-items-center">
                                        <span class="icon-svg">
                                            <svg class="" focusable="false" viewBox="0 0 24 24"
                                                aria-hidden="true">
