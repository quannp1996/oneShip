<div class="modal fade" id="modalNguoiGui" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
    <div class="modal-dialog modal-md " role="document">
        <div class="modal-content">
            ...
            <div class="modal-custom-form">
                <form action="#" @submit.prevent="storeSender">
                        ...
                        <div class="row">
                                    ...
                                    <div class="admin-form-item-control-input">
                                        <div class="admin-form-item-control-input-content">
                                            <input placeholder="Vui lòng nhập họ tên" id="name"
                                                class="admin-form-input" type="text" v-model="senderForm.fullname"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="admin-form-item-control-input">
                                        <div class="admin-form-item-control-input-content">
                                            <input placeholder="Vui lòng nhập số điện thoại" id="mobile"
                                                class="admin-form-input" type="text" v-model="senderForm.phone" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-6 mb-3">
                                ...
                                <div class="admin-form-item-control">
                                    <div class="admin-form-item-control-input">
                                        <div class="admin-form-item-control-input-content">
                                            <input placeholder="Vui lòng nhập email" id="email" class="admin-form-input" v-model="senderForm.email" type="text"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-6 mb-3">
                                <citiesdropdown :lable="'Tỉnh/ Thành phố'" :name="'sender_city'" :object="senderForm">
                                </citiesdropdown>
                            </div>
                            <div class="col-6 mb-3">
                                <districtdropdown :lable="'Quận/ Huyện'" :name="'sender_district'"
                                    :city_code="senderForm.province_id" :object="senderForm"></districtdropdown>
                            </div>
                            <div class="col-6 mb-3">
                                <warddropdown :lable="'Xã/ Phường'" :name="'sender_ward'"
                                    :district_code="senderForm.district_id" :object="senderForm"></warddropdown>
                            </div>
                            <div class="col-6 mb-3">
                                <div class="admin-form-item-label">
                                    ...
                                    <div class="admin-form-item-control-input">
                                        <div class="admin-form-item-control-input-content">
                                            <input placeholder="Vui lòng nhập mã zip code" id="zipcode"
                                                class="admin-form-input" type="text" v-model="senderForm.zipcode"/>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="admin-form-item-control-input">
                                        <div class="admin-form-item-control-input-content">
                                            <input placeholder="Vui lòng nhập " id="addr1" class="admin-form-input"
                                                type="text" v-model="senderForm.address1"/>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="admin-form-item-control-input">
                                        <div class="admin-form-item-control-input-content">
                                            <input placeholder="Vui lòng nhập" id="addr2" class="admin-form-input"
                                                type="text" v-model="senderForm.address2"/>
                                        </div>
                                    </div>
                                </div>
