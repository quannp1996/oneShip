<div class="tab-pane fade" id="receiver" role="tabpanel" aria-labelledby="receiver-tab">
    <div class="admin-table mt-20" v-if="listReceiver && listReceiver.length">
        <div class="admin-table-container">
            ...
            <div class="admin-table-body">
                <div>
                    <div class="d-flex custom-row" v-for="item in listReceiver">
    ...
    <div class="text-20 mt-30 mb-50 text-center font-weight-bold text-dark" v-else>
        ...
        <a class="btn-themes color-btn" href="javascript:;" data-toggle="modal" data-target="#modalNguoiNhan">
