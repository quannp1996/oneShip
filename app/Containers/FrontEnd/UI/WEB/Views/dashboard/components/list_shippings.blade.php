<div class="admin-card" v-if="shippings && shippings.length">
            ...
            <div class="admin-table-container">
                <table style="table-layout: auto;">
                    ...
                    <tbody class="admin-table-tbody">
                        <tr class="admin-table-row" v-for="item in shippings">
                            <td class="admin-table-cell text-center" v-text="item.id"></td>
