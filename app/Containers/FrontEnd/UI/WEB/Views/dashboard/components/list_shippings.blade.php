                ...
                <table style="table-layout: auto;">
                    ...
                    <thead class="admin-table-thead">
                        <tr>
                            ...
                            <th class="admin-table-cell" style="text-align: right;">Phí giao hàng</th>
                            <th class="admin-table-cell">Thao tác</th>
                        </tr>
                    </thead>
                    <tbody class="admin-table-tbody">
                        <tr class="admin-table-row">
                            <td class="admin-table-cell text-center">2</td>
                            <td class="admin-table-cell">
                                <div class="d-flex align-items-center flex-wrap" style="row-gap: 0px;">
                                    <img class=" mr-2 img-fluid" src="images/ic-ghtk.png" width="50" />
                                    <div>GHTK Standard</div>
                                </div>
                            </td>
                            <td class="admin-table-cell">
                            ...
                            <td class="admin-table-cell">
                                <div class="ant-row pickMethodRow-XO+K6h" style="row-gap: 0px;">
                                    <div class="d-flex align-items-start py-1 color-415066">
                                        <svg class="icon-svg color-415066 mr-2" focusable="false" viewBox="0 0 18 18"
                                            aria-hidden="true">
                            ...
                            <td class="admin-table-cell" style="text-align: center;">1-4 ngày</td>
                            <td class="admin-table-cell" style="text-align: right;"><span
                                    class="color-415066">VND</span> 28000</td>
                            <td class="admin-table-cell">
                                <button type="button" class="btn-themes nocolor-btn">
                                    <span role="img" class="icon-svg color-415066">
                        ...
                        <tr class="admin-table-row">
                            <td class="admin-table-cell text-center">3</td>
                            <td class="admin-table-cell">
                                <div class="d-flex align-items-center flex-wrap" style="row-gap: 0px;">
                                    <img class="img-fluid mr-2" src="images/ic-ghtk-standard.png" width="50" />
                                    <div>GHN-Standard</div>
                                </div>
                            </td>
                            <td class="admin-table-cell">
                                <div class="" style="row-gap: 0px;">
                                    <div class="d-flex align-items-start py-1 color-415066">
                                        <svg class="icon-svg color-415066" focusable="false" viewBox="0 0 18 18"
                                            aria-hidden="true">
                                            <path fill-rule="evenodd" clip-rule="evenodd"
                            ...
                            <td class="admin-table-cell" style="text-align: center;">2-5天</td>
                            <td class="admin-table-cell" style="text-align: right;"><span
                                    class="currency-BNkmwy">VND</span> 22800</td>
                            <td class="admin-table-cell">
                                <button type="button" class="btn-themes nocolor-btn">
                                    <span role="img" class="icon-svg">
