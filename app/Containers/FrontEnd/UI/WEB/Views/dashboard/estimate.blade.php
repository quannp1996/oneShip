...
@section('content')
    <div class="admin-main-layout" id="estimateVUE">
                        ...
                        <div class="admin-card-row">
                            <div class="col-3 mb-3">
                                <dropdown :name="'sender_city'" :object="sender" :lable="'Tỉnh/ Thành phố'"
                                    :first_text="'-- Chọn --'" :lists="provinces" :change="choseProvince"></dropdown>
                            </div>
                            <div class="col-3 mb-3">
                            ...
                            <div class="col-3 mb-3">
                                <dropdown :name="'sender_ward'" :object="sender" :lable="'Thôn/ Xóm'"
                                    :first_text="'-- Chọn --'" :lists="sender.wards" :change="choseWard"></dropdown>
                            </div>
                            <div class="col-3 mb-3">
                        ...
                        <div class="admin-card-row">
                            ...
                            <div class="col-3 mb-3">
                                <dropdown :name="'receiver_ward'" :object="receiver" :lable="'Thôn/ Xóm'"
                                    :first_text="'-- Chọn --'" :lists="receiver.wards" :change="choseWard"></dropdown>
                            </div>
                            <div class="col-3 mb-3">
                                <div class="admin-form-item-label">
                                    <label for="zipcode" class="admin-form-item-required" title="zipcode">
