            ...
            <div class="card card-accent-primary">
                <form action="{{ route('admin.customers.store') }}" method="POST">
                    ...
                    <div class="card-header d-flex">
                        <button class="btn btn-link">Tạo khách hàng mới</button>
                        <div class="ml-auto">
                            <button type="button" class="btn btn-secondary mr-2" onclick='return closeFrame()'>Đóng
                                lại</button>
                            <button type="submit" class="btn btn-primary"><i class="fa fa-save"></i> Lưu thông
                                tin</button>
                        </div>
                    </div>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ old('fullname', $data->fullname ?? '') }}" required />
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="customer_group_ids[]" id="customer_group_ids"
                                                    ...
                                                    @foreach ($groups as $group)
                                                        <option value="{{ $group->id }}" @if (in_array($group->id, old('customer_group_ids', []))) selected @endif>
                                                            {{ $group->title }}
                                                        </option>
                                                    @endforeach
                                                </select>
