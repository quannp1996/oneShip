...
use Apiato\Core\Traits\RenewCacheableRepository;
 ...
 */
abstract class Repository extends BaseRepository implements PrettusCacheable
{
    use RenewCacheableRepository;
