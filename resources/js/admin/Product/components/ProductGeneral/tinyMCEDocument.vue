<template>
    <editor v-model="document" :init="init"></editor>
</template>
...
<script>
    ...
    export default {
        ...
        computed: {
            document: {
                get() {
                    if (typeof this.$store.state.a.content[this.$store.state.a.tabLangID] !== 'undefined') {
                        return this.$store.state.a.content[this.$store.state.a.tabLangID].document;
                    }
                },
                set(value) {
