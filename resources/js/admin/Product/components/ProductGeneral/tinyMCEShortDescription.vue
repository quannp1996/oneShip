<template>
    <editor v-model="short_description" :init="init"></editor>
</template>
    ...
    export default {
        ...
        computed: {
            short_description: {
                get() {
                    if (
                        typeof this.$store.state.a.content[this.$store.state.a.tabLangID] !== 'undefined'
                    ) {
                        return this.$store.state.a.content[this.$store.state.a.tabLangID].short_description;
                    }
                },
                set(value) {
        ...
        data() {
            return {
                init: {
                    ...
                    fontsize_formats: '8px 9px 10px 11px 12px 13px 14px 15px 16px 18px 20px 24px 36px 48px 72px',
