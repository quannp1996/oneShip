        ...
        <div class="table-responsive">
            <table class="table table-striped">
                <thead>
                    <tr>
                        <th width="55">ID</th>
                        <th style="min-width:800px;">Tiêu đề</th>
                        <th >Ngày tạo</th>
                        <th width="55">Lệnh</th>
                    </tr>
                </thead>
                        ...
                        <tr v-for="post in laravelData.data" :key="post.id">
                            ...
                            <td>
                              <div class="actionIcon">
                                <router-link :to="'/tags/edit?id='+ post.id" ><i class="fa fa-pencil"></i></router-link>
                              </div>
                              <div class="actionIcon">
                                <router-link :to="'/tags'"  ><i @click='deleteTag(post.id)' class="fa fa-trash"></i></router-link>
                              </div>
                            </td>
                        </tr>
                </tbody>
...
export default {
  ...
  methods: {
    async dataTable(page = 1) {
        ...
        const url = 'admin/ajax/tags/controller/tagList?page='+page;
    ...
    async deleteElm(id) {
        const url = `admin/ajax/tags/controller/${id}/tagDelete`;
